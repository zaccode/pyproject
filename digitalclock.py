...
def date_time():
	...
	hr =time.strftime('%I') #%I denotes hours
	mi = time.strftime('%M')
	sec = time.strftime('%S')
	am = time.strftime('%p')
	...
	lab_hr.after(200,date_time) #continue recalling the program after 200 milisecond
...
lab_min_txt = Label(clock,text="Minute",font=("Time New Roman",20,"bold"),bg = 'red',fg='white')
...
lab_sec_txt = Label(clock,text="Second",font=("Time New Roman",20,"bold"),bg = 'red',fg='white')
...
lab_yr = Label(clock,text="00",font=("Time New Roman",60,"bold"),bg = 'red',fg='white')
lab_yr.place(x=560,y=270,height=110,width=100)

lab_yr_txt = Label(clock,text="Year",font=("Time New Roman",20,"bold"),bg = 'red',fg='white')
...
lab_day_txt = Label(clock,text="AM/PM",font=("Time New Roman",20,"bold"),bg = 'red',fg='white')
